      ...
      <div style={{ maxWidth: 980, margin: "0 auto", padding: "28px 16px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16 }}>
          <div>
            ...
            <div style={{ fontWeight: 800, color: "#374151", marginTop: 6 }}>Document Legitimacy Assistant</div>
        ...
        <Card>
          <div style={{ color: "#111827", lineHeight: 1.5 }}>
            {uiText(
              lang,
              "Docu-Lea te ayuda a entender cartas, avisos, facturas y correos que pueden ser confusos, urgentes o sospechosos. Toma una foto, sube un archivo o pega el texto, y te explicará qué es, si parece legítimo, y qué (si acaso) hacer después.",
              "Docu-Lea helps you understand letters, notices, bills, and emails that may be confusing, urgent, or suspicious. Take a photo, upload a file, or paste text, and it will explain what it is, whether it appears legitimate, and what (if anything) to do next."
            )}
          </div>
          ...
          <div style={{ marginTop: 10, fontSize: 13, color: "#6b7280" }}>
            {uiText(
              lang,
              "Tus documentos se analizan al instante y no se almacenan.",
...
<div style={{ height: 12 }} />
        ...
        <Card title="Paste a letter / email / message">
          <textarea
            ...
            placeholder="Paste a letter, email, or document text here…"
          />
